...
export const MOCK_SESSIONS: Session[] = [
  ...
  { id: 's2', venueId: 'v1', createdBy: 'u2', sessionDate: TODAY, startTime: '14:00', endTime: '16:00', court: 'A館', netHeight: 'female', sessionType: 'beginner',     price: 280, maxCapacity: 12, minSkillRequired: null,           maxSkillAllowed: 'D', status: 'open', notes: null, createdAt: TODAY + 'T00:00:00Z', updatedAt: TODAY + 'T00:00:00Z', venueName: '球魔方', currentCount: 8 },
  { id: 's3', venueId: 'v2', createdBy: 'u3', sessionDate: TODAY, startTime: '10:00', endTime: '12:00', court: null,  netHeight: 'male',   sessionType: 'intermediate', price: 380, maxCapacity: 12, minSkillRequired: 'B',  maxSkillAllowed: 'A', status: 'full', notes: null, createdAt: TODAY + 'T00:00:00Z', updatedAt: TODAY + 'T00:00:00Z', venueName: 'Ace', currentCount: 12 },
  { id: 's4', venueId: 'v3', createdBy: 'u2', sessionDate: TODAY, startTime: '14:00', endTime: '16:00', court: 'B館', netHeight: 'male',   sessionType: 'intermediate', price: 400, maxCapacity: 12, minSkillRequired: 'B',  maxSkillAllowed: null, status: 'open', notes: null, createdAt: TODAY + 'T00:00:00Z', updatedAt: TODAY + 'T00:00:00Z', venueName: '飛翼', currentCount: 9 },
  { id: 's5', venueId: 'v5', createdBy: 'u3', sessionDate: TODAY, startTime: '16:00', endTime: '18:00', court: null,  netHeight: 'male',   sessionType: 'advanced',     price: 450, maxCapacity: 10, minSkillRequired: 'A',      maxSkillAllowed: null, status: 'open', notes: '進階班', createdAt: TODAY + 'T00:00:00Z', updatedAt: TODAY + 'T00:00:00Z', venueName: 'Playone', currentCount: 7 },
]
